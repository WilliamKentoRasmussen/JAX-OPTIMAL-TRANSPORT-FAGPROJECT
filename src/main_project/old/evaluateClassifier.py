...
if __name__ == "__main__":
    original_images, expected_target_images = (
        np.load("data/original_images.npy"),
        np.load("data/expected_target_images.npy"),
    )
    intermediate_images = np.load("data/intermediate_images.npy")
