...
from sinkhorn_algorithm.sinkhorn import sinkhorn
import torch
...
if __name__ == "__main__":
    ...
    p1 = torch.from_numpy(pcu.load_mesh_v("src/sinkhorn_algorithm/data/wheel.ply")).to(device=device, dtype=dtype)
    p1 -= p1.min(dim=0)[0]
